...
<body>
    <div id="content-header" class="container-fluid header" style="display: none;">
        <div id="content-title">
            <h3 class="tlt" data-in-effect="bounceInDown">User : Baru</h3>
        </div>
        <div id="button-container" class="form-button"></div>
    </div>
    <div id="message-container" style="display: none; text-align: center"></div>
    <div id="content-main" class="content-center" style="display: none;">
        <div class="container-fluid">
            <div class="columns-1 col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-sm-6 col-sm-push-3 col-xs-12">
                ...
                echo "<input id='username' name='username' class='form-control' type='text' placeholder='Nama user'/>";
                echo "</div>";
                echo "<div class='form-group'>";
                echo "<label>Password</label>";
                echo "<input id='password' name='password' class='form-control' type='password' placeholder='Password'/>";
                echo "</div>";
                echo "<div class='form-group'>";
                echo "<label>Konfirmasi password</label>";
                echo "<input id='konfirmasi_password' name='konfirmasi_password' class='form-control' type='password' placeholder='Konfirmasi password'/>";
                echo "</div>";
                echo "<div class='form-group'>";
